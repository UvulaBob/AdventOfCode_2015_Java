...
public class Part1 {
    ...
    public static void main(String[] args) {
        ...
        int minimumGoldSpent = Integer.MAX_VALUE;
            ...
            for (Armor armor : armors) {
                for (Ring ring1 : rings) {
                    for (Ring ring2 : rings) {
                        ...
                        if (heroHitPoints > 0) {
                            minimumGoldSpent = (goldSpent < minimumGoldSpent) ? goldSpent : minimumGoldSpent;
                        }
                    }
                }
            }
        ...
        System.out.println("Minimum Gold Spent For Victory: " + minimumGoldSpent);
